...
<<<<<<< HEAD
    ...
    def borrow_book(self, book_id):
        ...
        for book in book_list:
            if str(book["_id"]) == str(book_id):  # tránh lỗi int vs string
    ...
    # Đây là method để nhập ID và gọi borrow_book
    ...
    # Đây là method để nhập ID và gọi return_book
    ...
    # Hàm này dùng để hiện thị sách đã mượn
    def list_borrowed_books(self):
        # Hiển thị danh sách các sách đã được mượn
